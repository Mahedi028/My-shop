...
import 'package:myapp/models/shop_class.dart';
...
class _ProductDetailsPageState extends State<ProductDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final _productDiscount =
        _product.first.price * (_product.first.discount / 100);
                            ...
                            Container(
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    'category : ${_product.first.categoryName}',
                                  )
                                ],
                              ),
                            ),
                            Container(
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                      'sub - category : ${_product.first.subCategoryName}')
                                ],
                              ),
                            ),
                            Container(
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                      'details : ${_product.first.productDetails}')
                                ],
                              ),
                            ),
                          ],
